...
export default function Quote(props) {
  ...
  const invoice = props.user.clients[props.clientId].quotes[props.invoiceId]
  ...
  const handleDeleteInvoice = async (clientId, invoiceId) => {
    ...
    if (confirmDelete) {
      ...
      try { 
        const response = await fetch(`/api/delete-client-quote?clientId=${clientId}&invoiceId=${invoiceId}`, {
          method: 'DELETE',
          headers: {
